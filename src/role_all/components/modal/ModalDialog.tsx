...
export function ModalDialog() {
	...
	return (
		<div
			ref={refModalDialog}
			className="flex flex-col invisible fixed justify-start bg-gray-900 border-2 border-lime-300 text-neutral-50 rounded-xl top-0 bottom-0 left-0 right-0 m-auto px-2 pt-2 z-30 pb-2 h-full lg:h-3/5 lg:max-w-xl"
		>
