...
export function ModalMessage() {
    ...
    return (
        <div ref={refModalMessage} id="modal-message" onClick={ closeModalMessage } className="fixed left-0 right-0 m-auto bottom-[-250px] rounded-t-xl h-auto w-80 z-40 bg-gray-700 p-2 flex flex-col space-y-5 text-white duration-1000 delay-300">
            { modalMessage.text }
        </div>
    );
}
