    ...
    return (
        <>
            ...
            <div className='flex justify-center flex-col items-center w-full mt-2 select-none'>
                {
                    ad.length ? ad.map((obj, index) => {
                        return <div key={ obj.href + index } className='flex m-2'>
                            <a target="_blank" rel="noreferrer" href={ obj.href }><img width="125" height="125" src={ obj.src } alt=""/></a>
                        </div>
