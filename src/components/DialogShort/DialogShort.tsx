...
export function DialogShort( dialog: IDialog ) {
    return (
        <div key={ dialog.timecode + dialog.age } className='flex items-center my-1 w-auto h-16 bg-gray-700 rounded-xl shadow-[0px_0px_1px_1px] shadow-lime-300 cursor-pointer' >
            <div 
                style={{ 
                    backgroundImage: 'URL(' + dialog.photolink[dialog.photomain] + ')' 
                }} 
            ...
            <div className='flex flex-col w-40 h-full m-1 overflow-hidden'>
                ...
                <div className='flex justify-center text-zinc-400 text-sm overflow-hidden select-none'>
