...
export function UserProfileFilters() {
    ...
    return (
        <div className="flex flex-wrap shadow-[0px_0px_3px_3px] shadow-lime-300 rounded-xl relative w-full items-center justify-center p-1 my-2">
            <Filters 
                location={ { value: myfiltersUser.location, onChange: filtersLocationOnChangeHandler } }
                ageStart={ { value: myfiltersUser.agestart, onChange: filtersAgeStartOnChangeHandler } }
                ageEnd={ { value: myfiltersUser.ageend, onChange: filtersAgeEndOnChangeHandler } }
                growthStart={ { value: myfiltersUser.growthstart, onChange: filtersGrowthStartOnChangeHandler } }
                growthEnd={ { value: myfiltersUser.growthend, onChange: filtersGrowthEndOnChangeHandler } }
                weightStart={ { value: myfiltersUser.weightstart, onChange: filtersWeightStartOnChangeHandler } }
                weightEnd={ { value: myfiltersUser.weightend, onChange: filtersWeightEndOnChangeHandler } }
                signZodiac={ { value: myfiltersUser.signzodiac, onChange: filtersSignZodiacOnChangeHandler } }
                genderVapor={ { value: myfiltersUser.gendervapor, onChange: filtersGenderVaporOnChangeHandler } }
                religion={ { value: myfiltersUser.religion, onChange: filtersReligionOnChangeHandler } }
                smoke={ { value: myfiltersUser.smoke, onChange: filtersSmokeOnChangeHandler } }
                alcohol={ { value: myfiltersUser.alcohol, onChange: filtersAlcoholOnChangeHandler } }
            />
        </div>
    );
}
